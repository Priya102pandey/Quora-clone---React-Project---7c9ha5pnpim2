      ...
      <div className='add-question'>
        <form action="#" method='post' onSubmit={handleSubmit} id='add-question-form'>
          <div className="question-input">
            ...
            <input  type="text"  name='question'  id='question' onChange={(e) => setQuestionInput(e.target.value)}
              placeholder='Type your question here..........'  value={questionInput}  minLength={8}   required   />
          </div>
